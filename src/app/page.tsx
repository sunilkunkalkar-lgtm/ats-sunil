    ...
    <div>
      <header className="page-head">
        <div>
          ...
          <h1>Hiring desk</h1>
          <p className="lede">
            One candidate record, one owner, a 21-day fulfillment clock, and a live offer-to-join
            funnel — built for four recruiters who can no longer share spreadsheets.
          </p>
        </div>
